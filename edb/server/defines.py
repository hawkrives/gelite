...
GELITE_TEMPLATE_DB = s_def.GELITE_TEMPLATE_DB
GELITE_OLD_DEFAULT_DB = 'edgedb'
GELITE_SUPERUSER_DB = 'main'
GELITE_SYSTEM_DB = s_def.GELITE_SYSTEM_DB
GELITE_ENCODING = 'utf-8'
GELITE_VISIBLE_METADATA_PREFIX = r'Gel metadata follows, do not modify.\n'

GELITE_SPECIAL_DBS = s_def.GELITE_SPECIAL_DBS

GELITE_CATALOG_VERSION = buildmeta.GELITE_CATALOG_VERSION
