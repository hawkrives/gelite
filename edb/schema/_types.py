...
TYPE_IDS = {
    ...
    sn.name_from_string('std::cal::local_datetime'): UUID(
        '00000000-0000-0000-0000-00000000010b'
    ),
    sn.name_from_string('std::cal::local_date'): UUID(
        '00000000-0000-0000-0000-00000000010c'
    ),
    sn.name_from_string('std::cal::local_time'): UUID(
        '00000000-0000-0000-0000-00000000010d'
    ),
    sn.name_from_string('std::cal::relative_duration'): UUID(
        '00000000-0000-0000-0000-000000000111'
    ),
    sn.name_from_string('std::cal::date_duration'): UUID(
        '00000000-0000-0000-0000-000000000112'
    ),
    sn.name_from_string('cfg::memory'): UUID(
        '00000000-0000-0000-0000-000000000130'
    ),
    sn.name_from_string('std::pg::json'): UUID(
        '00000000-0000-0000-0000-000001000001'
    ),
    sn.name_from_string('std::pg::timestamptz'): UUID(
        '00000000-0000-0000-0000-000001000002'
    ),
    sn.name_from_string('std::pg::timestamp'): UUID(
        '00000000-0000-0000-0000-000001000003'
    ),
    sn.name_from_string('std::pg::date'): UUID(
        '00000000-0000-0000-0000-000001000004'
    ),
    sn.name_from_string('std::pg::interval'): UUID(
        '00000000-0000-0000-0000-000001000005'
    ),
}
