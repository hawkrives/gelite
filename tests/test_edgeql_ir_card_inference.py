...
class TestEdgeQLCardinalityInference(tb.BaseEdgeQLCompilerTest):
    ...
    @tb.must_fail(errors.QueryError, "possibly an empty set", line=3, col=13)
    ...
    @tb.must_fail(
        errors.QueryError, "possibly more than one element", line=3, col=13
    )
    ...
    @tb.must_fail(errors.QueryError, "possibly more than one element")
    ...
    @tb.must_fail(errors.QueryError, "possibly an empty set returned")
